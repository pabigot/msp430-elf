...
;; idea how this happens.  So the peephole below is to catch this
...
(define_insn "movpsisi2"
  [(set (match_operand:SI             0 "register_operand" "=r")
	(subreg:SI (match_operand:PSI 1 "register_operand" "r") 0))]
  "TARGET_LARGE"
  "PUSHX.A\t%1 { POPM.W #2, %H0 ; Move pointer %1 into reg-pair %L0:%H0"
)
...
(define_insn "zero_extendqihi2"
  [(set (match_operand:HI                 0 "msp_nonimmediate_operand" "=rYs,r,m")
	(zero_extend:HI (match_operand:QI 1 "msp_nonimmediate_operand" "0,r,0")))]
  ""
  "@
   AND\t#0xff, %0
   MOV.B\t%1, %0
...
;; Eliminate extraneous zero-extends created by GCC.  Unfortunately we cannot
;; use TARGET_MODE_REP_EXTEND to do this as it does not accept a return value
;; of ZERO_EXTEND.
(define_peephole2
  [(set (match_operand:HI 0 "register_operand")
  ...
  "REGNO (operands[0]) == REGNO (operands[3]) && REGNO (operands[2]) == REGNO (operands[3])"
  [(set (match_dup 0)
