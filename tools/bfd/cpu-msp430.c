...
static const bfd_arch_info_type arch_info_struct[] =
{
  ...
  /* msp430x20x.  */
  N (16, bfd_mach_msp20, "msp:20", FALSE, & arch_info_struct[15]),

  /* msp430x22x.  */
  N (16, bfd_mach_msp22, "msp:22", FALSE, & arch_info_struct[16]),

  /* msp430x23x.  */
  N (16, bfd_mach_msp23, "msp:23", FALSE, & arch_info_struct[17]),

  /* msp430x24x.  */
  N (16, bfd_mach_msp24, "msp:24", FALSE, & arch_info_struct[18]),

  /* msp430x26x.  */
  N (16, bfd_mach_msp26, "msp:26", FALSE, & arch_info_struct[19]),

  /* msp430x46x.  */
  N (16, bfd_mach_msp46, "msp:46", FALSE, & arch_info_struct[20]),

  /* msp430x47x.  */
  N (16, bfd_mach_msp47, "msp:47", FALSE, & arch_info_struct[21]),

  /* msp430x54x.  */
  N (16, bfd_mach_msp54, "msp:54", FALSE, & arch_info_struct[22]),
  
  N (32, bfd_mach_msp430x, "msp:430X", FALSE, & arch_info_struct[23]),
