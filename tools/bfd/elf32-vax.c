...
elf_vax_finish_dynamic_sections (bfd *output_bfd, struct bfd_link_info *info)
{
  ...
  /* Make sure that the output version of the .got.plt exists.
     It may be missing from the linker script or have been removed
     via garbage collection.  */
  if (sgot->output_section && elf_section_data (sgot->output_section))
