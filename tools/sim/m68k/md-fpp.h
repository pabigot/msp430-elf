...
/* XXX nickc 9 Sep 2007: The math based versions of these functions
   may be endian independent, but they are inaccurate.  Try running
   gcc/testsuite/gcc.c-torture/execute/ieee/acc1.c at -O1 to see the
   problem in action.
   The replacement versions are accurate but host-endian dependent.
   Since I do not have any big-endian hosts available I have not
   bothered to code big-endian versions.  */
...
#if 1
    {
      union { double d; uae_u32 i[2]; } cnv;
      cnv.i[1] = wrd1;
      cnv.i[0] = wrd2;
      return cnv.d;
    }
