...
#if 0 /* XXX Work around host compiler bug.  */
...
#else
#define SET_ZFLG(y) (regflags.cznv = (y) ? (regflags.cznv | 0x040) : (regflags.cznv & ~0x040))
#define SET_CFLG(y) (regflags.cznv = (y) ? (regflags.cznv | 0x001) : (regflags.cznv & ~0x001))
#define SET_VFLG(y) (regflags.cznv = (y) ? (regflags.cznv | 0x800) : (regflags.cznv & ~0x800))
#define SET_NFLG(y) (regflags.cznv = (y) ? (regflags.cznv | 0x080) : (regflags.cznv & ~0x080))
#endif
