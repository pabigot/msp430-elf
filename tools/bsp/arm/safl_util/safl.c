/*
 *  safl.c - Linux driver for Intel(R) StrongARM(R) PCI-based coprocessor boards.
 *           This module currently supports EBSA-285 and SA-IOP.
 *
 ...
 */
static char *version =
"safl.c:v0.01H 04/02/99 Mark Salter, Cygnus Solutions.\n";
...
MODULE_AUTHOR("Mark Salter <msalter@cygnus.com>");
