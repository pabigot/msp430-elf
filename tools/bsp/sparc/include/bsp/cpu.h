/*
 * cpu.h -- SPARC-specific header for Cygnus BSP.
 *
...
/*
 * __NEED_UNDERSCORE__ is not defined for any SPARC targets
 */
...
#define SYSCALL()    asm volatile("         ta 8
                                            nop")
#define __cli()      asm volatile("         rd     %psr,%l0
                                            orn    %g0,0xf00,%l1
                                            and    %l0,%l1,%l0
                                            wr     %l0,%psr")
#define __sti()      asm volatile("         rd     %psr,%l0
                                            or     %l0,0xf00,%l1
                                            wr     %l0,%psr")
...
static inline void __set_ps(unsigned val)
{
    ...
    asm volatile ("mov %0,%%psr\n" : /* no outputs */ : "r" (psr_val) );
}

#define IRQ_FLAG unsigned
#define DISABLE_IRQ(x) { x = __get_ps(); __set_ps(x | 0xf00); }
